...
// BuscarPorID busca uma publicação do banco de dados
...
// Buscar busca todas as publicações do usuário e dos usuários seguidos
...
// Atualizar atualiza os dados de uma publicação no banco de dados
...
// Excluir exclui uma publicação no banco de dados
