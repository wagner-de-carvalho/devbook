...
// Atualizar atualiza usuário no banco de dados
...
// Excluir excluir usuário pelo id
...
// BuscarPorEmail busca usuário no banco pelo e-mail
...
// PararDeSeguirUsuario permite usuario parar de seguir outro
...
// BuscarSenha busca senha do usuário, pelo id, gravada no banco de dados
func (repositorio Usuarios) BuscarSenha(usuarioID uint64) (string, error) {
	linha, erro := repositorio.db.Query("select senha from usuarios where senha = ?", usuarioID)
	if erro != nil {
		return "", erro
	}
	defer linha.Close()
...
// AtualizarSenha atualiza a senha do usuário no banco de dados
